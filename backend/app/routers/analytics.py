...
def get_analytics(
    ...
    for log in sorted_logs:
        ...
        cumulative_retail_cost += log_retail_cost
        ...
        if date_str not in daily_data:
            daily_data[date_str] = {
                ...
                "volume_ml": 0,
                "co2_cost": 0,
                "retail_cost": cumulative_retail_cost,
        ...
        daily_data[date_str]["retail_cost"] = cumulative_retail_cost
